...
console.log("Create a function that will return the datatype parameter")
...
console.log("Create a function that will take in a variable number of arguments and return their product")
variableNumberArgs(2,2,3,1,4)
...
console.log("Create a function that iterates over an integer array and returns their sum")
returnIntArraySum()
